...
\label{sec:jonas}
Em 2024, um cliente frustrado conseguiu convencer o chatbot de atendimento da transportadora britânica DPD a "ignorar as regras", xingar a própria empresa e escrever um haiku \footnote{Haiku: forma de poema curto de origem japonesa, tradicionalmente estruturado em três versos com contagem fixa de sílabas (5-7-5). HOUAISS, Antônio; VILLAR, Mauro de Salles. \textbf{Dicionário Houaiss da língua portuguesa}. Rio de Janeiro: Objetiva, 2001. Verbete: haicai.} insultando o serviço prestado. O episódio levou a empresa a desativar o componente de IA no mesmo dia \cite{theregister2024dpd}. Esse caso ilustra um problema que segue em evidência: os mecanismos que impedem uma LLM de responder a instruções antiéticas podem ser contornados por meio de prompts cuidadosamente contextualizados, o que levanta preocupações relevantes de segurança.

Esse tipo de vulnerabilidade tem sido tema de pesquisas na literatura. Nesta seção, discutiremos os dois caminhos em que a pesquisadores dividem essas falhas: os ataques focados em convencer o modelo a responder, usando técnicas de persuasão da psicologia \cite{noughabi2025uncoveringpersuasivefingerprintllms, ke2025iterativepromptingpersuasionskills}, e os ataques técnicos focados em induzir o modelo a iniciar a resposta com certas palavras, manipulando os canais de acesso das chaves de API \cite{li2025prefillleveljailbreakblackboxrisk}.
